const HEROES = {
    'knight': {
        icon: '♘', type: window.PIECE_TYPES.HERO, moveStrategy: 'knight',
    ...
    'archer': {
        icon: '♗', type: window.PIECE_TYPES.HERO, moveStrategy: 'bishop', range: 3,
    ...
    'warrior': {
        icon: '♔', type: window.PIECE_TYPES.HERO, moveStrategy: 'king',
